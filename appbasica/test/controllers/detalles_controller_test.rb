...
class DetallesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create detalle" do
    assert_difference('Detalle.count') do
      post detalles_url, params: { detalle: { cantidad: @detalle.cantidad, precio_venta: @detalle.precio_venta, producto_id: @detalle.producto_id } }
    end
  ...
  test "should update detalle" do
    patch detalle_url(@detalle), params: { detalle: { cantidad: @detalle.cantidad, precio_venta: @detalle.precio_venta, producto_id: @detalle.producto_id } }
