...
class RegistrosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create registro" do
    assert_difference('Registro.count') do
      post registros_url, params: { registro: { fecha: @registro.fecha, numero_orden: @registro.numero_orden } }
    end
  ...
  test "should update registro" do
    patch registro_url(@registro), params: { registro: { fecha: @registro.fecha, numero_orden: @registro.numero_orden } }
